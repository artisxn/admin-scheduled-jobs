...
use codicastudio\NovaScheduledJobs\Schedule\Cron;
use codicastudio\NovaScheduledJobs\Tests\Fixtures\Jobs\UpdateOrders;
use codicastudio\NovaScheduledJobs\Vendor\CronSchedule;
...
class ListJobsTest extends TestCase
{
    ...
    {
        $response = $this->getJson('nova-vendor/codicastudio/admin-scheduled-jobs/jobs');
    ...
    {
        $kernel = app('codicastudio\NovaScheduledJobs\Tests\Fakes\Kernel', [
            'scheduledJobs' => [
                [
                    'command' => 'cache:clear',
